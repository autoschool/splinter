<section class="post">
    ...
    <#--<img class="entry-avatar" alt="Paul Laros" height="52" width="52" src="http://www.gravatar.com/avatar/ea67e860739cd91fe40b6797e97e6820.jpg?s=52">-->
        ...
        <p class="entry-meta">
            Posted on <a class="entry-date" href="#">${post.created_at}</a> | By <a class="entry-author" href="/profile/1">Paul Gilbert</a><#-- | Tags <a class="label label-danger" href="tag.html">CSS3</a>-->
        </p>
    </header>
